...
namespace Collision
{
	...
	bool SphereOverlapsBox(const Transform& t1, float r1, const Transform& t2, const Vector3& extent2);
	bool BoxOverlapsBox(const Transform& t1, const Vector3& extent1, const Transform& t2, const Vector3& extent2);
